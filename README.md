...
vpc infrastructure décrit par le code l'infrastructure à provisionner pour ... de avrtoken.
...
- [Github Actions](https://docs.github.com/en/actions) est l'outil d'intégration et de déploiement continu intégré à GitHub
    - L'historique des déploiements est disponible [sous l'onglet Actions](https://github.com/avrtoken/vpc-infrastructure/actions/)
- Secrets du dépôt :
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `avrtoken.vpc.infrastructure`
    - Groupe : `vpc.deployer`
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    ...
    - Workspaces : `vpc`
        - [vpc-production](https://app.terraform.io/app/avrtoken/workspaces/vpc)
    - Variables
